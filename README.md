...
- **Web**: [Render](https://aulas-autoescola-detranrj.onrender.com/)
...
```
git clone https://github.com/AlexSouzaSilvax/desempenho-aulas-detranrj.git
```

```
cd desempenho-aulas-detranrj
```
...
```
VITE_API_URL=https://api-desempenho-aulas-detranrj.onrender.com/api/
```
...
_Este projeto foi criado para ajudar na consulta das aulas de Auto Escola, para saber se foram COMPUTADAS no Detran._
